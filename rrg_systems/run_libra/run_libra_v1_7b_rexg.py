...
output_file = "../RadEval/rrg_systems/run_libra/answers/libra.v1.7b.rexgradient.test.findings.tok"

# load the ground truth findings file
findings_file= open(".../RadEval/rrg_systems/...").readlines()
...
images_file = open("../RadEval/rrg_systems/rexgradient/test.images.tok").readlines()
