...
output_file = "../RadEval/rrg_systems/run_libra/answers/libra.v1.7b.chex.test.findings.tok"
...
images_file = open("../RadEval/rrg_systems/chexpert/valid.findings.image.tok").readlines()
