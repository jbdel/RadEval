...
output_file = "/mnt/primary/RadEval/libra_answer/libra.v0.CXRGen.I.mimic.test.impression.tok"

# load the ground truth findings file
findings_file= open("/mnt/primary/RadEval/rrg_systems/mimic-cxr/test.impression.tok").readlines()
...
images_file = open("/mnt/primary/RadEval/rrg_systems/mimic-cxr/test.impression.image.libra.tok").readlines()
