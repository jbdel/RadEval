...
class F1RadbertCT:
    ...
    @torch.no_grad()
    def _predict_label_matrix(self, reports: Sequence[str], on_batch_done=None) -> np.ndarray:
        chunks = []
    ...
    def forward(self, hyps: List[str], refs: List[str], on_batch_done=None) -> Tuple[float, List[float], dict]:
